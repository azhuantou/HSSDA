...
class WaymoDataset(DatasetTemplate):
    ...
    def include_waymo_data(self, mode):
        ...
        num_skipped_infos = 0
        if mode == 'train':
            info_path = '/data/cqupt/code/semi_idea/data/waymo/waymo_processed_data_v0_5_0_infos_train.pkl'
            with open(info_path, 'rb') as f:
                infos = pickle.load(f)
                waymo_infos.extend(infos)
        elif mode == 'test':
            info_path = '/data/cqupt/code/semi_idea/data/waymo/waymo_processed_data_v0_5_0_infos_val.pkl'
            with open(info_path, 'rb') as f:
                infos = pickle.load(f)
                waymo_infos.extend(infos)
        else:
