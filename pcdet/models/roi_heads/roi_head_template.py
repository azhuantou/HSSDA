...
class RoIHeadTemplate(nn.Module):
    ...
    def get_box_reg_layer_loss(self, forward_ret_dict):
        ...
        if loss_cfgs.REG_LOSS == 'smooth-l1':
            ...
            # my code
            if forward_ret_dict['re_weight_rcnn_cls_labels'] is not None:
                rcnn_loss_reg = rcnn_loss_reg * \
                                 forward_ret_dict['re_weight_rcnn_cls_labels'].view(-1).unsqueeze(0).unsqueeze(-1).\
                                     expand_as(rcnn_loss_reg)
    ...
    def get_box_cls_layer_loss(self, forward_ret_dict):
        ...
        if loss_cfgs.CLS_LOSS == 'BinaryCrossEntropy':
            ...
            # my code
            if forward_ret_dict['re_weight_rcnn_cls_labels'] is not None:
                batch_loss_cls = batch_loss_cls * forward_ret_dict['re_weight_rcnn_cls_labels'].view(-1)
